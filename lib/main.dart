  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const ProgressiveImageExample(),
      ),
    );
  }
}
...
class ProgressiveImageExample extends StatelessWidget {
  const ProgressiveImageExample({super.key});

  // Image Credit - https://unsplash.com/@tjholowaychuk
  Widget get example1 => ProgressiveImage(
    placeholder: const AssetImage('assets/images/placeholder.jpg'),
    thumbnail: const NetworkImage('https://i.imgur.com/eOQL4jg.jpg'), // 64x36
    image: const NetworkImage('https://i.imgur.com/mDQ3Qbi.jpg'), // 3842x2160
    height: 250,
    width: 500,
    fit: BoxFit.cover,
  );
  ...
  Widget get example4 => ProgressiveImage.custom(
    ...
    thumbnail: const NetworkImage('https://i.imgur.com/4WRfwXm.jpg'), // 64x43
    image: const NetworkImage('https://i.imgur.com/0NnZINx.jpg'), // 3240x2160
    height: 250,
    width: 500,
    fit: BoxFit.cover,
  );
